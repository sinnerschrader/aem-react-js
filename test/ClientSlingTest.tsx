...
import ClientSling from "../store/ClientSling";
...
describe("ClientSling", () => {
    ...
    it("should subscribe to cached resource", () => {
        ...
        let listener: ResourceComponent<any, any, any> = new (class MockResourceComponent extends ResourceComponent<any, any, any> {
    ...
    it("should subscribe to resource", () => {
        ...
        sling.subscribe((listener as ResourceComponent<any, any, any>), path, {depth: 1});
