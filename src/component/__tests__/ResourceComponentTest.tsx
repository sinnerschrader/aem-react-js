...
describe("ResourceComponent", () => {
    ...
    it("should render loading message", () => {
        ...
        let item = enzyme.mount(<RootComponent aemContext={aemContext} comp={Test} path="/content/notfound"/>);
    ...
    it("should render htl children wcmmode disabled", () => {
        ...
        cache.put("/content", {
            "child1": {
                "jcr:primaryType": "nt:unstructured", "sling:resourceType": "htl/test", "text": "Hallo",
            },
        });

        container.register("sling", new MockSling(cache));

        const item = enzyme.render(<RootComponent wcmmode="disabled" aemContext={aemContext} comp={AemContainer}
                                                                                     path="/content"/>);
    ...
    describe("should render htl children wcmmode enabled", () => {
        ...
        it("default ", () => {
            const item = enzyme.render(<RootComponent wcmmode="edit" aemContext={aemContext} comp={AemContainer}
                                                                                         path="/content"/>);
        ...
        it("with child wrapper ", () => {
            const item = enzyme.mount(<RootComponent wcmmode="disabled" aemContext={aemContext}
    ...
    describe("should render react children wcmmode disabled", () => {
        before(() => {
            ...
            cache.put("/content",
                {
                    "child1": {
                        "jcr:primaryType": "nt:unstructured", "sling:resourceType": "test", "text": "OOPS",
                    },
                });
        ...
        it("with child wrapper", () => {
            const item = enzyme.render(<RootComponent wcmmode="disabled" aemContext={aemContext}
                                                                                         comp={createContainer("childClass", "el")}
                                                                                         path="/content"/>);
